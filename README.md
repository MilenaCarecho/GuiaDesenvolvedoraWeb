...
1. Conhecer a internet e o funcionamento dela
   pra isso seprarei 3 videos do curso de HTML5 do Curso em vídeo, e é por la que você começa
...
Tem muito conteúdo na internet de HTML5, muitos cursos gratuitos. Mas não se prenda a eles, a melhor forma de aprender é colocando a mão na massa, o curso linkado ja fornece a base necessaria para que você aprenda a realizar suas buscas na docuementação da W3School ou na apostila de HTML :relaxed:
